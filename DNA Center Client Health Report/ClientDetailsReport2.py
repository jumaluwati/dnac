...
#  
# this code generates a client detail report on dna center utilizing the native DNA Center APIs (URL + Tokens method)
...
#Report Type (in this case we are getting the client details one)
...
#Getting the report view group parameter
...
#Getting the report view ID parameter
...
#Gettign the detailed report views
...
def main():
    ...
    # Up to this part we are generating the report on DNAC
    #--------------------------------------------------------------------------------
    # The below part gets us the info we need, which is the average health score
